...
# 📖 Math Magicians <a name="list structure"></a>
...
- Here is the [live-demo](https://ahmedeid6842.github.io/Math-Magicians/)
...
```bash
git clone https://github.com/ahmedeid6842/Math-Magicians.git
